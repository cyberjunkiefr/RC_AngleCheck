...
def calc_angle():
    ...
    accelx = readaccelx(1000)    
    angle = (asin(-accelx)*57.28835) - angleoffset
    milli = sin(angle)*corde
...
def count_calibrating():
    ...
    tft.fill_rect(30,50,200,vga1_8x16.HEIGHT,colors.BLUE)      
    accelx = readaccelx(1000)    
    angleoffset = asin(-accelx)*57.28835
